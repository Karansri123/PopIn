  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
      <div className='flex flex-col md:flex-row items-center justify-between w-full'>
        <Title align='left' title='Exclusive Offers' subTitle='Make the most of our limited-time offers and exclusive packages to elevate your stay and create unforgettable moments.'/>
        <button className='group flex items-center gap-2 font-medium cursor-pointer max-md:mt-12'>See What’s on Offer

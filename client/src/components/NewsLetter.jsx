...
const NewsLetter = () => {
  return (
    <div className="flex flex-col items-center  max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-800 text-white">
        <Title title='Stay Inspired' subTitle='Embark on a journey with us — get early access to hidden gems, exclusive deals, and wanderlust-worthy inspiration.'/>
